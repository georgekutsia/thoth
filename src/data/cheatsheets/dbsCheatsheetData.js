const dbsCheatsheetData = {   //rodeas de doble ** ** para mostrar texto azul y "" para mostar en negrita. Se encarta formattedTextComponent
  básico :[
  {title:"DBS to expect",
...
export default dbsCheatsheetData;