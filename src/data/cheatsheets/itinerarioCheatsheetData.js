const itinerarioCheatsheetData = {   //rodeas de doble ** ** para mostrar texto azul y "" para mostar en negrita. Se encarta formattedTextComponent
  básico :[
  {title:"itinerario to expect",
 ...
 códigos :[
  {title:"Hello, world",
    ...
    textSub2c:`"void": Indica que el método no retorna ningún valor.`,
    textSub2d:`"main": Es el nombre específico que Java busca como punto de entrada en una aplicación.`,
    url:"https://res.cloudinary.com/dtv1oj9bq/image/upload/v1730650601/System.out.print_qxrkdb.png",
  },],
 button :[
  {title:"básico"},
  {title:"arrays"},
...
export default itinerarioCheatsheetData;