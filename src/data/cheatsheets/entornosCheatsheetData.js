const entornosCheatsheetData = {   //rodeas de doble ** ** para mostrar texto azul y "" para mostar en negrita. Se encarta formattedTextComponent
  básico :[
  {title:"Entornos to expect",
...
export default entornosCheatsheetData;