...
function DayNightBtn({ handleClick, isNightMode }) {
  return (
    <>
      <input
        type="checkbox"
        id="darkmode-toggle"
        checked={isNightMode === "body-night"} // Si es noche, debe estar marcado
        onChange={() => handleClick()} // Llama a handleClick al cambiar
      />
      <label className="day-night-btn" htmlFor="darkmode-toggle" 
      data-aos="flip-right"
      >
        {/* SVG del Sol (Sun) */}
        <svg
...
DayNightBtn.propTypes = {
  handleClick: PropTypes.func.isRequired,
  isNightMode: PropTypes.string.isRequired, // Asegúrate de recibir el estado isNightMode
};
